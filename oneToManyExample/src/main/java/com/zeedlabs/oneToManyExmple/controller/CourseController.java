package com.zeedlabs.oneToManyExmple.controller;
...
import com.zeedlabs.oneToManyExample.repository.CourseRepository;
import com.zeedlabs.oneToManyExample.repository.InstructorRepository;
...
public class CourseController {
    ...
    public Course createCourse(@PathVariable(value = "instructorId") Long instructorId,
        @Validated @RequestBody Course course) throws ResourceNotFoundException {
    ...
    public Course updateCourse(@PathVariable(value = "instructorId") Long instructorId,
        @PathVariable(value = "courseId") Long courseId, @Validated @RequestBody Course courseRequest)
