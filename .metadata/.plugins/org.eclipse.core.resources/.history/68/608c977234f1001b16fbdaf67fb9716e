	...
	public void setMailing(boolean mailing) {
		...
		public String toString() {
			return "Customer [id=" + id + ", firstname=" + firstname + ", lastname=" + lastname + ", phonenumber="
					...
					+ stateofresidence + ", gender=" + gender + ", married=" + married + ", email=" + email
					+ ", birthdate=" + birthdate + ", enlistmentdate=" + enlistmentdate + ", designation=" + designation
					+ ", ippisnumber=" + ippisnumber + ", bvnnumber=" + bvnnumber + ", terms=" + terms + ", mailing="
					+ mailing + "]";
		}
}