...
import com.zeedlabs.productmanager.crud.repository.CustomerRepository;
import com.zeedlabs.productmanager.crud.service.CustomerService;
...
public class CustomerController {
	...
	public String showRegistrationForm(Model model) {
	  ...
	  Customer user) { System.out.println(user);
